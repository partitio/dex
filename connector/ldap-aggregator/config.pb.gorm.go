...
// LdapConfigRepository is a default repository
type LdapConfigRepository interface {
	// CreateLdapConfig executes a basic gorm create call
	CreateLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error)
	// ListLdapConfig executes a gorm list call
	ListLdapConfig(ctx context.Context) ([]*LdapConfig, error)
	// ReadLdapConfig executes a basic gorm read call
	ReadLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error)
	// DeleteLdapConfig executes a basic gorm delete call
	DeleteLdapConfig(ctx context.Context, in *LdapConfig) error
	// DeleteLdapConfigSet executes a basic gorm delete set call
	DeleteLdapConfigSet(ctx context.Context, in []*LdapConfig) error
	// StrictUpdateLdapConfig clears first level 1:many children and then executes a gorm update call
	StrictUpdateLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error)
	// PatchLdapConfig executes a basic gorm update call with patch behavior
	PatchLdapConfig(ctx context.Context, in *LdapConfig, updateMask *field_mask1.FieldMask) (*LdapConfig, error)
}

func NewLdapConfigRepository(db *gorm1.DB) (LdapConfigRepository, error) {
	if db == nil {
	...
	return &DefaultLdapConfigRepository{db: db}, nil
}

// DefaultLdapConfigRepository implements LdapConfigRepository
type DefaultLdapConfigRepository struct {
	db *gorm1.DB
}

func (r *DefaultLdapConfigRepository) CreateLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error) {
	return DefaultCreateLdapConfig(ctx, in, r.db)
}
func (r *DefaultLdapConfigRepository) ReadLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error) {
	return DefaultReadLdapConfig(ctx, in, r.db)
}
func (r *DefaultLdapConfigRepository) DeleteLdapConfig(ctx context.Context, in *LdapConfig) error {
	return DefaultDeleteLdapConfig(ctx, in, r.db)
}
func (r *DefaultLdapConfigRepository) DeleteLdapConfigSet(ctx context.Context, in []*LdapConfig) error {
	return DefaultDeleteLdapConfigSet(ctx, in, r.db)
}
func (r *DefaultLdapConfigRepository) StrictUpdateLdapConfig(ctx context.Context, in *LdapConfig) (*LdapConfig, error) {
	return DefaultStrictUpdateLdapConfig(ctx, in, r.db)
}
func (r *DefaultLdapConfigRepository) PatchLdapConfig(ctx context.Context, in *LdapConfig, updateMask *field_mask1.FieldMask) (*LdapConfig, error) {
	return DefaultPatchLdapConfig(ctx, in, updateMask, r.db)
}
func (r *DefaultLdapConfigRepository) ListLdapConfig(ctx context.Context) ([]*LdapConfig, error) {
	return DefaultListLdapConfig(ctx, r.db)
}

// UserSearchRepository is a default repository
type UserSearchRepository interface {
	// CreateUserSearch executes a basic gorm create call
	CreateUserSearch(ctx context.Context, in *UserSearch) (*UserSearch, error)
	// ListUserSearch executes a gorm list call
	ListUserSearch(ctx context.Context) ([]*UserSearch, error)
}

func NewUserSearchRepository(db *gorm1.DB) (UserSearchRepository, error) {
	if db == nil {
		return nil, errors2.New("db cannot be nil")
	}
	if err := db.AutoMigrate(&UserSearchORM{}).Error; err != nil {
		return nil, err
	}
	return &DefaultUserSearchRepository{db: db}, nil
}

// DefaultUserSearchRepository implements UserSearchRepository
type DefaultUserSearchRepository struct {
	db *gorm1.DB
}

func (r *DefaultUserSearchRepository) CreateUserSearch(ctx context.Context, in *UserSearch) (*UserSearch, error) {
	return DefaultCreateUserSearch(ctx, in, r.db)
}
func (r *DefaultUserSearchRepository) ListUserSearch(ctx context.Context) ([]*UserSearch, error) {
	return DefaultListUserSearch(ctx, r.db)
}

// GroupSearchRepository is a default repository
type GroupSearchRepository interface {
	// CreateGroupSearch executes a basic gorm create call
	CreateGroupSearch(ctx context.Context, in *GroupSearch) (*GroupSearch, error)
	// ListGroupSearch executes a gorm list call
	ListGroupSearch(ctx context.Context) ([]*GroupSearch, error)
}

func NewGroupSearchRepository(db *gorm1.DB) (GroupSearchRepository, error) {
	if db == nil {
		return nil, errors2.New("db cannot be nil")
	}
	if err := db.AutoMigrate(&GroupSearchORM{}).Error; err != nil {
		return nil, err
	}
	return &DefaultGroupSearchRepository{db: db}, nil
}

// DefaultGroupSearchRepository implements GroupSearchRepository
type DefaultGroupSearchRepository struct {
	db *gorm1.DB
}

func (r *DefaultGroupSearchRepository) CreateGroupSearch(ctx context.Context, in *GroupSearch) (*GroupSearch, error) {
	return DefaultCreateGroupSearch(ctx, in, r.db)
}
func (r *DefaultGroupSearchRepository) ListGroupSearch(ctx context.Context) ([]*GroupSearch, error) {
	return DefaultListGroupSearch(ctx, r.db)
}
